...
public class MoreListDataPump {
    public static LinkedHashMap<String, List<MoreListDataItem>> getData() {
        ...
        stats.add(new MoreListDataItem("League Table", "https://www.evostikleaguesouthern.co.uk/league-table/Evo-stik%20League%20South%20Division%20One%20Central/2019/2020/P/", R.drawable.ic_table, R.color.yeltzBlueOverlay));
