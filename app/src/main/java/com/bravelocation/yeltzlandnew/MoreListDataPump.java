...
public class MoreListDataPump {
    public static LinkedHashMap<String, List<MoreListDataItem>> getData() {
        ...
        stats.add(new MoreListDataItem("League Table", "https://www.evostikleaguesouthern.co.uk/league-table/Evo-stik%20League%20South%20Premier%20Division%20Central/", R.drawable.ic_table, R.color.yeltzBlueOverlay));
